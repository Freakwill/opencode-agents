...
\author{Song Congwei \thanks{*Corresponding author: Williamxxoo@gmail.com}\\
...
startup\cite{alzubi2026,he2026memoryarena,li2026bmam,xia2026}. 
...
The skill snippet above provides simple long-term memory functionality. It initially realizes self‑evolution of agents without fine‑tuning the LLM parameters. A more complete example can be found at \cite{agent-memory-systems}.
