...
(\url{https://opencode.ai/docs/commands/}), but when defined in a skill/agent
...
\subsection{Simple Agent Memory
...
\subsection{Dialogue Example (Personality
...
capabilities of skills and agents\cite{alzubi2026,xia2026}.
